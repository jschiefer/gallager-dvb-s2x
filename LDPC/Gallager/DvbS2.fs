...
let codingTable = 
    [
        ( (Long, Rate_1_4), { KBch = 16008; KLdpc = 16200; BchTError = 12; NLdpc = 64800; q = 135; AccTable = ldpc_1_4N } )
        ( (Long, Rate_1_3), { KBch = 21408; KLdpc = 21600; BchTError = 12; NLdpc = 64800; q = 120; AccTable = ldpc_1_3N } )
        ( (Long, Rate_2_5), { KBch = 25728; KLdpc = 25920; BchTError = 12; NLdpc = 64800; q = 108; AccTable = ldpc_2_5N } )
        ( (Long, Rate_1_2), { KBch = 32208; KLdpc = 32400; BchTError = 12; NLdpc = 64800; q = 90; AccTable = ldpc_1_2N } )
        ( (Long, Rate_3_5), { KBch = 38688; KLdpc = 38880; BchTError = 12; NLdpc = 64800; q = 72; AccTable = ldpc_3_5N } )
        ( (Long, Rate_2_3), { KBch = 43040; KLdpc = 43200; BchTError = 10; NLdpc = 64800; q = 60; AccTable = ldpc_2_3N } )
        ( (Long, Rate_3_4), { KBch = 48408; KLdpc = 48600; BchTError = 12; NLdpc = 64800; q = 45; AccTable = ldpc_3_4N } )
        ( (Long, Rate_4_5), { KBch = 51648; KLdpc = 51840; BchTError = 12; NLdpc = 64800; q = 36; AccTable = ldpc_4_5N } )
        ( (Long, Rate_5_6), { KBch = 53840; KLdpc = 54000; BchTError = 10; NLdpc = 64800; q = 30; AccTable = ldpc_5_6N } )
        ( (Long, Rate_8_9), { KBch = 57472; KLdpc = 57600; BchTError = 8; NLdpc = 64800; q = 20 ; AccTable = ldpc_8_9N } )
        ( (Long, Rate_9_10), { KBch = 58192; KLdpc = 58320; BchTError = 8; NLdpc = 64800; q = 18; AccTable = ldpc_9_10N } )
        ( (Short, Rate_1_4), { KBch = 3072; KLdpc = 3240; BchTError = 12; NLdpc = 16200; q = 36; AccTable = ldpc_1_4S } )
        ( (Short, Rate_1_3), { KBch = 5232; KLdpc = 5400; BchTError = 12; NLdpc = 16200; q = 30; AccTable = ldpc_1_3S } )
        ( (Short, Rate_2_5), { KBch = 6312; KLdpc = 6480; BchTError = 12; NLdpc = 16200; q = 27; AccTable = ldpc_2_5S } )
        ( (Short, Rate_1_2), { KBch = 7032; KLdpc = 7200; BchTError = 12; NLdpc = 16200; q = 25; AccTable = ldpc_1_2S } )
        ( (Short, Rate_3_5), { KBch = 9552; KLdpc = 9720; BchTError = 12; NLdpc = 16200; q = 18; AccTable = ldpc_3_5S } )
        ( (Short, Rate_2_3), { KBch = 10632; KLdpc = 10800; BchTError = 12; NLdpc = 16200; q = 15; AccTable = ldpc_2_3S } )
        ( (Short, Rate_3_4), { KBch = 11712; KLdpc = 11880; BchTError = 12; NLdpc = 16200; q = 12; AccTable = ldpc_3_4S } )
        ( (Short, Rate_4_5), { KBch = 12432; KLdpc = 12600; BchTError = 12; NLdpc = 16200; q = 10; AccTable = ldpc_4_5S } )
        ( (Short, Rate_5_6), { KBch = 13152; KLdpc = 13320; BchTError = 12; NLdpc = 16200; q = 8; AccTable = ldpc_5_6S } )
        ( (Short, Rate_8_9), { KBch = 14232; KLdpc = 14400; BchTError = 12; NLdpc = 16200; q = 5; AccTable = ldpc_8_9S } )
    ] |> Map.ofList
